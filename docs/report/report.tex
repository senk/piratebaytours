...
Ein entscheidender Punkt in der Geschäftslogik einer Anwendung wie der Pirate-Bay-Tours ist der Bereich der Buchungslogik. Da die Agenten die meiste Zeit offline arbeiten, muss ein Weg gefunden werden einerseits den Agenten den Spielraum zu geben um auch größeren Gruppen Angebote machen zu können. Andererseits sollten Überbuchungen vermieden werden, da diese zu Verstimmungen bei den Kunden sowie Rück- oder gar Entschädigungszahlungen für das Unternehmen führen.\\
